...
public:
                 ...
                 const edm::EventSetup &) const override 
    {
        ...
        table->addColumn<float>("dlen", dlen, "dlen of SV", nanoaod::FlatTable::FloatColumn);
        table->addColumn<float>("dlenSig", dlenSig, "dlenSig of SV", nanoaod::FlatTable::FloatColumn);
